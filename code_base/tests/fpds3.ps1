...
#   Requirements query.
#
#$fulluri = Add_route -uri $myuri -route "/Lists/FpdsExtentCompeted" -query "B"
$fulluri = Add_route -uri $myuri -routeId 67 -query "B"
...
if ($Response.StatusCode -eq 200) {
   ...
   if ($mine.result.Name -eq "Not Available for Competition") {
