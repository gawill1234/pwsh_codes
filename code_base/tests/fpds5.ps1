...
#   Requirements query.
#
#$fulluri = Add_route -uri $myuri -route "/Lists/FpdsIdcType" -query "B"
$fulluri = Add_route -uri $myuri -routeId 68 -query "B"
...
if ($Response.StatusCode -eq 200) {
   ...
   if ($mine.result.Name -eq "IDC/Indefinite Quantity") {
