...
#   Requirements query.
#
#$fulluri = Add_route -uri $myuri -route "/Lists/FpdsContractingOfficeCode" -query "36C10B"
$fulluri = Add_route -uri $myuri -routeId 66 -query "36C10B"
...
if ($Response.StatusCode -eq 200) {
   ...
   if ($mine.result.Name -eq "TECHNOLOGY ACQUISITION CENTER") {
