...
#   Requirements query.
#
$argSet = addArguments -newArgName "BasePIID" -newArgValue "V564P-1102"
...
if ($Response.StatusCode -eq 200) {
   ...
   if ($mine.Result.Contract.Vendor.VendorName.Contains("ARKANSAS WILBERT")) {
