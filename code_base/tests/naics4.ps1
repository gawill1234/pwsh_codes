...
#   Requirements query.
#
#$fulluri = Add_route -uri $myuri -route "/Lists/NaicsCode/Planning" -query 111211
$fulluri = Add_route -uri $myuri -routeId 71 -query 111211
...
if ($Response.StatusCode -eq 200) {
   ...
   if ($mine.result.Name -eq "Potato Farming") {
