...
#   Vendor query.
#
$argSet = addArguments -newArgName "VendorUEI" -newArgValue "DVNBAHCP4U66"
...
Write-Host "VendorUEI parameter alone" -f magenta
if ($Response.StatusCode -eq 200) {
   $mine = ($Response.Content | ConvertFrom-Json)
   if ($mine.Result.Vendors[0].ContractorUEI.Contains("DVNBAHCP4U66")) {
