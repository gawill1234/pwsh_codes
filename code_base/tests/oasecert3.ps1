...
#   Vendor query.
#
#$fulluri = Add_route -uri $myuri -route "OAS/Ecert/User/Accreditations" -query 90909
$fulluri = Add_route -uri $myuri -routeId 40 -query 90909
...
Write-Host "Non-existent userid" -f magenta
