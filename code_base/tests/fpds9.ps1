...
#   Requirements query.
#
#$fulluri = Add_route -uri $myuri -route "/Lists/FpdsReasonForModification" -query "B"
$fulluri = Add_route -uri $myuri -routeId 70 -query "B"
...
if ($Response.StatusCode -eq 200) {
   ...
   if ($mine.result.Name -eq "Supp. Agreement for work") {
