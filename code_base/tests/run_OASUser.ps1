...
#   Vendor query.
#
#$fulluri = Add_route -uri $myuri -route "OAS" -query "gary.williams1@va.gov"

$argSet = addArguments -newArgName "Email" -newArgValue "gary.williams1@va.gov"
$fulluri = Add_route -uri $myuri -routeId 39 -query $argSet
