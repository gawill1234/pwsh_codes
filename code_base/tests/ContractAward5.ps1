...
$argSet = addArguments -sofar $argSet -newArgName "EndDate" -newArgValue "2025-13-30"
...
if ($mine.ResponseStatus.ErrorCode -eq 4004) {
   if ($mine.ResponseStatus.Message.Contains("not valid for EndDate")) {
