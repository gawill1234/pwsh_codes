...
$tname = "ood14d_del.ps1"

#
#   Get the Id created by ecor9.ps1
#
if (Test-Path -Path ".\ood14d.dat") {
   $dumpId = Get-Content -Path ".\ood14d.dat"
} else {
   Write-Host $tname": Id input file not found (ood14d.dat)" -f Red
