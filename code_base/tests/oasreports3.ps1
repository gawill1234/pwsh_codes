...
#   Vendor query.
#
#$fulluri = Add_route -uri $myuri -route "OAS/Reports" -query "hello"
$fulluri = Add_route -uri $myuri -routeId 47 -query "hello"
...
Write-Host $tname": ASB - OAS/Reports bad id (string not int)" -f magenta
