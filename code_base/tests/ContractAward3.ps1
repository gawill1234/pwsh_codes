...
#   Requirements query.
#
$argSet = addArguments -newArgName "StartDate" -newArgValue "10/01/2025"
$argSet = addArguments -sofar $argSet -newArgName "EndDate" -newArgValue "10/30/2025"
...
if ($Response.StatusCode -eq 200) {
   ...
   if ($mine.ContractsAwarded.Count -gt 0) {
      if ($mine.ContractsAwarded[0].BasePIID -ne "" -and $mine.ContractsAwarded[0].BasePIID -ne $null) {
