...
#   Vendor query.
#
#$fulluri = Add_route -uri $myuri -route "OAS/Locations/Stations" -query 90909
$fulluri = Add_route -uri $myuri -routeId 51 -query 90909
...
Write-Host $tname": ASB - OAS/Locations/Stations station id does not exist" -f magenta
